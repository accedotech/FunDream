...
INSERT INTO `categories` VALUES (1,'Alimentos'),(2,'Empresarial'),(3,'Deportes'),(4,'Servicios'),(5,'Estética'),(6,'Arte'),(7,'Tecnología'),(8,'Salud'),(9,'Mascotas'),(10,'Educación'),(11,'Ambiental');
...
CREATE TABLE `idea` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_lk8yf0fpy90jcrdqrikfqlqh2` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rel_idea_categories` (
  ...
  KEY `FKqxx8824n1ssxb3bpvodojc0ol` (`idea_id`),
...
CREATE TABLE `rel_user_idea` (
  ...
  KEY `FKbuem1f7leewgrwwe3uuphic9e` (`usuario_id`),
...
-- Dump completed on 2019-07-24 18:32:38
